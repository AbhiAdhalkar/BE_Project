...
<h1 style="color:orange; text-shadow: 0.5px 0.5px 0.5px red;">E - Toilet</h1>
    <div class=" w3l-login-form">
        <h2 style="color:red; text-shadow: 0.5px 0.5px 0.5px white;">Admin Login</h2>
        <form action="LoginAdmin" method="POST">
            ...
            <div class="col-sm-offset-5 col-sm-10" style="color:yellow;">
                    Municipal corporation Login? <a href="loginMC.jsp"><font color="White">Click Here</font> </a>
            </div>
