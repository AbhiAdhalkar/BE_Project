...
float: right;
font-size: 16px;"> &nbsp; <a href="loginMC.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
            </nav>   
            <!-- /. NAV TOP  -->
      ...
      <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
<!--          		<h2>&nbsp&nbspMunicipal Corporation panel</h2>
 -->         		
          		<img src="images/adminpanel.webp" style="width:100%;height:100%">
  <div class="col-md-12">
          <div class="card">
